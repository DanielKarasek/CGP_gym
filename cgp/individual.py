...
class IndividualSingleGenome(IndividualBase):
    ...
    # xkaras38
    def distance(self, other_individual: "IndividualSingleGenome") -> float:
        return self.genome.distance(other_individual.genome)
    ...
    def calculate_count_per_function(self) -> Dict[str, int]:
        ...
        """
        return self.genome.calculate_count_per_function()
